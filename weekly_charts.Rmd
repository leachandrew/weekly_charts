...
```{r , child = 'stories/uk_prices.Rmd'}
```

```{r , child = 'stories/hydrogen.Rmd'}
```

```{r , child = 'stories/Japan_shift.Rmd'}
```

```{r , child = 'stories/nunatsiavut.Rmd'}
```

```{r , child = 'stories/solarshipments.Rmd'}
```
...
```{r wpsr_setup, cache=TRUE,eval=TRUE,eval=TRUE}
