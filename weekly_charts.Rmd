...
```{r eia_spot_prices, cache=KEEP_EIA_CACHE,eval=TRUE,eval=FALSE} 
...
```{r , child = 'stories/rystad.Rmd'}
```

```{r , child = 'stories/ChicagoSolar.Rmd'}
```

```{r , child = 'stories/four_day.Rmd'}
```

```{r , child = 'stories/Ford.Rmd'}
```
...
```{r wpsr_setup, cache=TRUE,eval=TRUE,eval=FALSE}
...
### Production
```{r us_crude_prod,eval=TRUE, echo = FALSE, warning=FALSE, message=FALSE,results="asis", cache=FALSE,fig.width=10,fig.pos="H",eval=FALSE}
...
```{r us_crude_imp,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE,results="asis", cache=FALSE, fig.width=10, fig.pos="H",eval=FALSE}
...
```{r us_crude_net_imp, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H",eval=FALSE}
...
```{r us_crude_inv, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H",eval=FALSE}
...
```{r nat_gas_store,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H",eval=FALSE}
...
aeso_fwds<-ggplot(df1 %>% filter(Trade_Date %in% dates, Inst_Date<=Trade_Date+years(3))) +
