...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '2022-11-18.html'), output_format = "all")})
...
```{r , child = 'stories/vanadiumchina.Rmd'}
```


```{r , child = 'stories/opec_iea.Rmd'}
```


```{r , child = 'stories/oil_bad_week.Rmd'}
```
