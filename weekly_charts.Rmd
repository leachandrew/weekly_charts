...
```{r , child = 'stories/clp.Rmd'}
```


```{r , child = 'stories/differentials.Rmd'}
```


```{r , child = 'stories/tidal_uk.Rmd'}
```


```{r , child = 'stories/india_solar.Rmd'}
```


```{r , child = 'stories/industry.Rmd'}
```


```{r , child = 'stories/francewindfarm.Rmd'}
```
