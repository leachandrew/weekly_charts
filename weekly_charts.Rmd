...
```{r story_3, child = 'stories/yyc_netzero.Rmd'}
```



```{r story_1, child = 'stories/kenney_oil_exp.Rmd'}
```


```{r story_4, child = 'stories/andrew_ab_power.Rmd'}
```


```{r story_2, child = 'stories/andrew_bitcoin.Rmd'}
```
...
### Production
```{r cdn_prod_graph, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H"}
