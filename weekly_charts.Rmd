...
```{r gas_maps, echo = FALSE, warning=FALSE, message=FALSE,cache=FALSE,results=FALSE}
# run the gas map and charts chunks and use the variables it creates
<<gas_weekly>>
<<gas_map>>
```
...
```{r map, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10,fig.height=7, fig.pos="H"}
weekly_map
```
