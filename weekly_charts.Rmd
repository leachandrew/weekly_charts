...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '2023_01_06.html'), output_format = "all")})
...
```{r , child = 'stories/keystone_ret.Rmd'}
```

```{r , child = 'stories/germany.Rmd'}
```

```{r , child = 'stories/bio.Rmd'}
```
