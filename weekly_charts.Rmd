...
```{r feature_crude, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
...
```{r alberta_crude, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
...
```{r global_crude, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
...
### Brent-WTI
```{r diffs_brent, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("Brent","WTI")
diffs_chart(data=data,names,5,curr="USD")
```

### WTI-WCS
```{r diffs_wcs, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("WTI","WCS")
diffs_chart(data=data,names,5,curr="USD")
```
...
### WTI-WCS (Short)
```{r diffs_wcs_short, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("WTI","WCS")
diffs_chart(data=data,names,1,curr="USD")
```

### Maya-WCS
```{r diffs_maya, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("Maya","WCS")
diffs_chart(data=data,names,5,curr="USD")
```
...
```{r diffs_5, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("Brent","Urals")
diffs_chart(data=data,names,5,curr="USD")
```
...
### WTI
```{r wti_fwd, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_BB_CACHE, fig.width=10, fig.pos="H",dpi=220}
...
### Brent
```{r brent_fwd, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_BB_CACHE, fig.width=10, fig.pos="H",dpi=220}
...
```{r map, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_KALIBRATE_CACHE, fig.width=10,fig.height=7, fig.pos="H",dpi=220}
load("weekly_map.gph")
weekly_map
```
...
```{r gas_histories, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_KALIBRATE_CACHE, fig.width=10,fig.height=7, fig.pos="H",dpi=220}
load("gas_plot.gph")
weekly_gas_plot
```
...
```{r diesel_histories, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_KALIBRATE_CACHE, fig.width=10,fig.height=7, fig.pos="H",dpi=220}
...
```{r cdn_ref_runs, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_CER_CACHE, fig.width=10, fig.pos="H",dpi=220}
ref_run_graph 
```


### Western Canada Refinery Runs
```{r west_ref_runs, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_CER_CACHE, fig.width=10, fig.pos="H",dpi=220}
west_runs 
```
...
```{r feature_gas, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
...
```{r feature_gas_short, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
names<-c("AECO NIT","Henry Hub","Dawn","Station 2")
...
```{r global_gas_long, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
...
```{r global_gas, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H",dpi=220}
data<-data %>% mutate(`NBP UK`=`NBP Gas`*`GBP USD`/10)
names<-c("AECO NIT","Henry Hub","Japan LNG JCC","NBP UK")
...
```{r na_gas, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_BB_CACHE, fig.width=10, fig.pos="H",dpi=220}
...
### Henry Hub
```{r hh_fwd, echo = FALSE, warning=FALSE, message=FALSE, results="asis", cache=KEEP_BB_CACHE, fig.width=10, fig.pos="H",dpi=220}
...
### Alberta (NIT) ($CAD)
```{r NGX_nit_cad,fig.width=10, fig.pos="H",cache=KEEP_BB_CACHE,dpi=220}
...
### Alberta (NIT)
```{r NGX_nit,fig.width=10, fig.pos="H",cache=KEEP_BB_CACHE,dpi=220}
date_max<-max(ngx_data$trade_date)
series_sent<-c("AB-NIT Fixed")
date_list<-rev(c(date_max,date_max-months(1)))
label_list<-c("Alberta NIT")
...
### BC (Stn 2) 
```{r NGX_stn2,fig.width=10, fig.pos="H",cache=KEEP_BB_CACHE,dpi=220}
date_max<-max(ngx_data$trade_date)
...
### Ontario (Dawn)
```{r NGX_dawn,fig.width=10, fig.pos="H",cache=KEEP_BB_CACHE,dpi=220}
date_max<-max(ngx_data$trade_date)
