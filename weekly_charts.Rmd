...
```{r , child = 'stories/batteryboom.Rmd'}
```

```{r , child = 'stories/pakrenewables.Rmd'}
```

```{r , child = 'stories/hydrogen_comm.Rmd'}
```

```{r , child = 'stories/home_solar.Rmd'}
```

```{r , child = 'stories/ab_hydro.Rmd'}
```
...
### Production
```{r us_crude_prod,eval=TRUE, echo = FALSE, warning=FALSE, message=FALSE,results="asis", cache=FALSE,fig.width=10,fig.pos="H",eval=TRUE,dpi=220}
...
```{r us_crude_imp,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE,results="asis", cache=FALSE, fig.width=10, fig.pos="H",eval=TRUE,dpi=220}
...
```{r us_crude_net_imp, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H",eval=TRUE,dpi=220}
...
```{r us_crude_inv, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H",eval=TRUE,dpi=220}
...
```{r nat_gas_store,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10,dpi=220, fig.pos="H",eval=TRUE}
