...
```{r , child = 'stories/Crypto.Rmd'}
```

```{r , child = 'stories/NS_Power.Rmd'}
```

```{r , child = 'stories/oil_cap.Rmd'}
```

```{r , child = 'stories/EU_Crisis.Rmd'}
```

# Last Week's Stories {.tabset .tabset-fade}


```{r , child = 'stories/copper.Rmd'}
```

```{r , child = 'stories/copper_2.Rmd'}
```

```{r , child = 'stories/inflation.Rmd'}
```

```{r , child = 'stories/irving.Rmd'}
```

```{r , child = 'stories/NuclearLowEnergy.Rmd'}
```
...
### Production
```{r us_crude_prod,eval=TRUE, echo = FALSE, warning=FALSE, message=FALSE,results="asis", cache=FALSE, fig.width=10, fig.pos="H"}
...
```{r us_crude_imp,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=FALSE, fig.width=10, fig.pos="H"}
...
```{r us_crude_net_imp, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H"}
...
```{r us_crude_inv, eval=TRUE,echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H"}
...
```{r nat_gas_store,eval=TRUE, echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_EIA_CACHE, fig.width=10, fig.pos="H"}
...
#### [July 9, 2022](https://leachandrew.github.io/weekly_charts/2022_07_09.html)
...
<a href="https://www.ualberta.ca/energy-systems/research.html">Brought to you by Andrew Leach and our FES Grids and Storage Research Team. Thanks to NRGStream for data accesss!</a></p>
  <p style="text-align: center;">aleach@ualberta.ca</p>
