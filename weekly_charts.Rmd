...
dates<-c(today_date,today_date-months(1),today_date-months(6),today_date-months(12))
#dates<-c(today_date,today_date-years(1))
#dates<-c(today_date)

aeso_fwds<-ggplot(df1 %>% filter(Trade_Date %in% dates,Type=="FLAT") %>% filter(Inst_Date<=Trade_Date+years(3))) +
