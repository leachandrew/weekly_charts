...
```{r story_1, child = 'stories/story_1.Rmd'}
```

```{r story_2, child = 'stories/story_2.Rmd'}
```


```{r story_3, child = 'stories/story_3.Rmd'}
```
...
gen_mix_plot<-ggplot(gen_mix,aes(date,gen, group=Source, fill = Source)) +
  ...
  scale_fill_manual("",values=c(colors_ua10()[1],colors_ua10()[4],colors_ua10()[3],colors_ua10()[2],colors_ua10()[5],colors_ua10()[6]))+
...
```{r prices_and_loads,fig.width=10, fig.pos="H",warning=FALSE,cache=KEEP_BB_CACHE}
...
```{r aeso_mix_plot, echo = FALSE, warning=FALSE,message=FALSE, results="asis", cache=KEEP_BB_CACHE, fig.width=10, fig.pos="H"}
gen_mix_plot
```
