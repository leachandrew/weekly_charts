...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '2023_01_27.html'), output_format = "all")})
editor: source 
---
...
```{r , child = 'stories/rbc_finance.Rmd'}
```

```{r , child = 'stories/imperial.Rmd'}
```

```{r , child = 'stories/spending.Rmd'}
```

```{r , child = 'stories/africasolar.Rmd'}
```
