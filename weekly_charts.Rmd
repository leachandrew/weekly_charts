...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, '2022-09-30.html'), output_format = "all")})
...
```{r , child = 'stories/IRA2.Rmd'}
```

```{r , child = 'stories/YEG_solar.Rmd'}
```

```{r , child = 'stories/RBC.Rmd'}
```
